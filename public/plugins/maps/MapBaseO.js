...
var oMap = L.map('mapid').setView([33.21, -97.13],13);
...
function onLocationFound(e) {
    oMap.panTo(e.latlng);
    L.marker(e.latlng, {icon: circleIcon}).addTo(oMap).bindPopup('Current location: ' + e.latlng.lat.toPrecision(6) + ', ' + e.latlng.lng.toPrecision(6));
}
oMap.on('locationfound', onLocationFound);
